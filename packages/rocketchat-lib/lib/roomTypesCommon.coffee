#RocketChat.Orgs = new class
#	getRouteLink: (id, subscriptionData) ->
#		routeData = {}
#
##		if @roomTypes[roomType]?.route?.link?
##			routeData = @roomTypes[roomType].route.link(subData)
#		if subData?.name?
#			routeData = { url: subscriptionData.url }
#
#		return FlowRouter.path id, routeData
#
#	openRouteLink: (id, subscriptionData, queryParams) ->
#
#		routeData = {}
#
##		if @roomTypes[roomType]?.route?.link?
...
#			routeData = { url: subscriptionData.url }
#
#		return FlowRouter.go id, routeData, queryParams
#
#
