...
#	@section 'Vk', ->
#		enableQuery = { _id: 'Accounts_OAuth_Custom-Vk', value: true }
#
#		@add 'Accounts_OAuth_Custom-Vk', false, { type: 'boolean', public: true }
#		@add 'Accounts_OAuth_Custom-Vk-id', '5896022', { type: 'string', enableQuery: enableQuery }
#		@add 'Accounts_OAuth_Custom-Vk-button_label_text', 'icon-vk', { type: 'string', enableQuery: enableQuery }
#		@add 'Accounts_OAuth_Custom-Vk-client_secret ', 'n0axcviQ1qJ84JzAk0oD', { type: 'string', enableQuery: enableQuery }
#		@add 'Accounts_OAuth_Custom-Vk-scope', 'email, last_name, first_name', { type: 'string', enableQuery: enableQuery }
#		@add 'Accounts_OAuth_Custom-Vk-url', 'https://oauth.vk.com', { enableQuery: enableQuery }
#		@add 'Accounts_OAuth_Custom-Vk-identity_path', 'https://api.vk.com/method/users.get', { enableQuery: enableQuery }
#		@add 'Accounts_OAuth_Custom-Vk-token_path', '/access_token', { enableQuery: enableQuery }
#		@add 'Accounts_OAuth_Custom-Vk_callback_url', '_oauth/vk', { type: 'relativeUrl', readonly: true, force: true, enableQuery: enableQuery }

#	@section 'Vk3', ->
#		enableQuery = { _id: 'Accounts_OAuth_Custom-Vk3', value: true }
#
#		@add 'Accounts_OAuth_Custom-Vk3', false, { type: 'boolean', public: true }
#		@add 'Accounts_OAuth_Custom-Vk3_id', '5946352', { type: 'string', enableQuery: enableQuery }
#		@add 'Accounts_OAuth_Custom-Vk3-button_label_text', 'icon-vk', { type: 'string', enableQuery: enableQuery }
#		@add 'Accounts_OAuth_Custom-Vk3_secret ', 'eY3BF9amdKnZCwxznVqS', { type: 'string', enableQuery: enableQuery }
#		@add 'Accounts_OAuth_Custom-Vk3_scope', 'email', { type: 'string', enableQuery: enableQuery }
#		@add 'Accounts_OAuth_Custom-Vk3-url', 'https://oauth.vk.com', { enableQuery: enableQuery }
#		@add 'Accounts_OAuth_Custom-Vk3-identity_path', 'https://api.vk.com/method/users.get', { enableQuery: enableQuery }
#		@add 'Accounts_OAuth_Custom-Vk3-token_path', 'https://oauth.vk.com/access_token', { enableQuery: enableQuery }
#		@add 'Accounts_OAuth_Custom-Vk3_callback_url', '_oauth/vk3', { type: 'relativeUrl', readonly: true, force: true, enableQuery: enableQuery }
