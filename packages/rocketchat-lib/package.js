...
Package.onUse(function(api) {
	...
	api.addFiles('server/methods/likeUser.js', 'server');
	api.addFiles('server/methods/likeOrgs.js', 'server');
	api.addFiles('server/methods/setCity.js', 'server');
	api.addFiles('server/methods/triggerRuletka.js', 'server');
	...
	api.addFiles('server/methods/setOrientation.js', 'server');
	api.addFiles('server/methods/setBirthday.js', 'server');
	api.addFiles('server/methods/setDescription.js', 'server');
	api.addFiles('server/methods/setMood.js', 'server');
	api.addFiles('server/methods/setHomeCity.js', 'server');
	api.addFiles('server/methods/setInteres.js', 'server');
	api.addFiles('server/methods/setSex.js', 'server');
	api.addFiles('server/methods/setRestDate.js', 'server');
	api.addFiles('server/methods/setMobile.js', 'server');
	api.addFiles('server/methods/setWhere.js', 'server');
	...
	api.addFiles('server/methods/setUserGeo.js', 'server');
