...
#		console.log(user)
		...
		UsersMoodValue = UsersMood.curValue
#
#		console.log('Записываю настроение 1 ')
#		console.log(user.mood)
#		console.log(user)
#		UsersMoodValue[user.username] =
#			_id: user._id
#			mood: user.mood
#
#		UsersMood.set UsersMoodValue

#	updateUserMood = (user, mood) ->
#		UsersMoodValue = UsersMood.curValue
#
##		console.log('Записываю настроение 2 ')
##		console.log(mood)
##		console.log(user)
#		UsersMoodValue[user.username] =
#			_id: user._id
