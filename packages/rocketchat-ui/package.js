...
Package.onUse(function(api) {
	...
	api.addFiles('views/app/nearby.html', 'client');
	...
	api.addFiles('views/catalog/catalogList.html', 'client');
	api.addFiles('views/catalog/orgItem.html', 'client');
	api.addFiles('views/catalog/orgList.html', 'client');
	api.addFiles('views/catalog/addNewOrgFront.html', 'client');
	...
	api.addFiles('views/app/nearby.coffee', 'client');
	...
	api.addFiles('views/notifications/router.coffee', 'client');
	api.addFiles('views/notifications/notifications.html', 'client');
	api.addFiles('views/notifications/notifications.coffee', 'client');
	api.addFiles('views/catalog/catalogList.coffee', 'client');
	api.addFiles('views/catalog/orgItem.coffee', 'client');
	api.addFiles('views/catalog/orgList.coffee', 'client');
	api.addFiles('views/catalog/addNewOrgFront.coffee', 'client');
});
