...
Package.onUse(function(api) {
	...
	//api.addFiles('catalog/catalogEat.html', 'client');
	//api.addFiles('catalog/catalogKafe.html', 'client');
	...
	//api.addFiles('catalog/catalogEat.coffee', 'client');
	//api.addFiles('catalog/catalogKafe.coffee', 'client');
